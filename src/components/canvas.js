...
class Canvas extends React.Component {
  componentDidMount() {
    ...
    img.onload = () => {
      ...
      ctx.fillText("21-ENE-2022", 340, 161);    // date from
      ctx.fillText("India", 90, 193);           // destiny
      ctx.fillText("Invitado", 340, 193);    // category
      ctx.fillText("1", 60, 280);       // gate = 1
      ctx.fillText("777", 180, 280);    // fligh = 777
      ctx.fillText("19:00", 320, 280);    // boardingtime = 15:12
      ...
      ctx.fillText("21ENE22", 565, 250);    // date from
      ctx.fillText("19:00", 655, 250);    // time
      ctx.fillText("INV", 725, 250);    // Class
